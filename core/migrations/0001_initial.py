    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('leader', 'Ministry Leader'), ('admin', 'Administrator')], default='leader', max_length=10)),
                ...
                ('associated_parish', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.parish')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('associated_parish', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.parish')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('associated_ministry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.ministry')),
            ],
        ),
        migrations.CreateModel(
            name='EventException',
            fields=[
                ...
                ('status', models.CharField(choices=[('cancelled', 'Cancelled'), ('rescheduled', 'Rescheduled')], max_length=12)),
