...
/*
 * Edits:
 * - "Add Event" button for group administrators
 */
...
/* WARNING! This file may change in the near future as we intend to add features to BuddyPress - 2012-02-14 */
	...
	?>
	<?php 
		/* if the user is a group admin, show a link to add an event to the group */
		if (groups_is_user_admin(get_current_user_id(), $bp->groups->current_group->id )) { 
	?>
	<a class="group-button button" title="Add Event" href="<?php echo $bp->events->link . 'my-events/edit/?action=edit&group_id=' . $bp->groups->current_group->id; ?>">Add Event</a>
	<?php 	
		} 
	?>
	<div class="tablenav">
